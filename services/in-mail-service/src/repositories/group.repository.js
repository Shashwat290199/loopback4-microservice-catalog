...
var GroupRepository = /** @class */ (function (_super) {
    __extends(GroupRepository, _super);
    function GroupRepository(dataSource, getCurrentUser) {
        var _this = _super.call(this, models_1.Group, dataSource, getCurrentUser) || this;
