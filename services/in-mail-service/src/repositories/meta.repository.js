...
var MetaRepository = /** @class */ (function (_super) {
    __extends(MetaRepository, _super);
    function MetaRepository(dataSource, getCurrentUser) {
        var _this = _super.call(this, models_1.Meta, dataSource, getCurrentUser) || this;
        _this.getCurrentUser = getCurrentUser;
        return _this;
    }
    MetaRepository = __decorate([
